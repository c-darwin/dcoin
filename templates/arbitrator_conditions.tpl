...
$('#skip').bind('click', function () {
	fc_navigate ('<?php echo $tpl['navigate']?>', {'skip_commission': 1} );
});
...
<ol class="breadcrumb">
	...
	<div id="change_commission">
		...
		<button class="btn" id="save"><?php echo $lng['send_to_net']?></button> <button  class="btn" id="skip"><?php echo $lng['skip']?></button><br><br>
