...
<div id="main_div">
	<h1 class="page-header"><?php echo $lng['transfer_of_credit']?></h1>
	<ol class="breadcrumb">
		<li><a href="#wallets_list"><?php echo $lng['wallets']?></a></li>
		<li><a href="#credits"><?php echo $lng['credits']?></a></li>
		<li class="active"><?php echo $lng['transfer_of_credit']?></li>
	</ol>
		...
		<div class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<span class="help-block"><?php echo $lng['new_creditor_user_id']?></span>
				</div>
			</div>
