		...
		var refreshId = setInterval( function() {
			$.post( 'ajax/synchronization_blockchain.php', {}, function (data) {
					...
					if (data.block_id>1) {
						...
						console.log(d);
						var pct = Math.round(data.block_id/190000*100);
						$('#meter').width(pct+'%');
						$('#meter').text(pct+'%');
...
<div style="max-width: 600px; margin: auto; text-align: center">
	...
	<div id="blocks_counter" style="display: <?php echo $tpl['wait']?'none':'block'?>">
		...
		<div class="meter1">
			<span style="width: <?php echo round(($tpl['block_id']/190000)*100)?>%; height: 20px; color: #fff" id="meter"><?php echo round(($tpl['block_id']/190000)*100)?>%</span>
		</div>
	</div>
