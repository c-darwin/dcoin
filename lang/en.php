...
$lng['your_new_key_rules'] = 'The new key will enter into force only after it will DC-network until the act is either the old master key. <br><strong> Sure to save and print the key! </strong> If you lose one of their private keys, access to your account will be irretrievably lost.';
...
// wallets_list
$lng['wallets_list_title'] = 'My wallets';
