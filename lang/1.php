...
$lng['applications_from_exchange'] = 'Applications from the exchange for buying dCoins';
$lng['details'] = 'Details';
$lng['best_rate'] = 'Best rate';
$lng['miners_on_the_map'] = 'Miners on the map';
$lng['promised_amounts_of_cash'] = 'Promised amounts of cash';
$lng['total_amount_of_coins'] = 'Total volume of created coins';
$lng['profit_forecast'] = 'Profit forecast';
$lng['after_1_year'] = 'after year';
$lng['promised'] = 'Promised';
$lng['on_the_account'] = 'On the account';
$lng['home_account_text'] = 'There are two ways to add money to your Dcoin (general name for currencies: dWOC, dUSD, dENR, etc.) account:<Br>1. Buy dCoins on the exchange.<br>2. Mine (participate in creation) of dCoins – in order to do so one needs to complete registration and make a promise to give up, if such request occurs, some money to another miner (user, participating in dCoin creation).';
$lng['home_dwoc_text'] = 'dWOC are money that only have their exchange value. Like other dCoins (dUSD, dEUR, etc.), they can be exchanged for any other currency, as well as for actual cash.';
$lng['home_dc_text'] = 'd[currency] – money, that are exchangeable for cash [currency] from another miner (user, participating in dCoin creation) at the exchange rate 1d[currency]=1[currency], or traded on the exchange. ';
$lng['home_ex_text'] = 'These are the amounts of actual US Dollars, added to the exchange for the purchase of dCoins (dWOC, dUSD, dEUR, etc.) and offer the best exchange rate to sell dCoins.';
$lng['home_promised_text'] = 'These are the amounts of actual cash, which miners (users participating in dCoin creation) are willing to exchange for the relevant dCoins (dUSD, dEUR, etc.)..';
$lng['home_promised_text_personal'] = 'These are the amounts of actual cash, which miners (users participating in Dcoin creation) are willing to exchange for [currency].';
$lng['home_pct_y_promised_text'] = 'This is a %, with which [currency] is created on miner’s account (miner is a user that participates in dCoin creation) for his or her promised amount.';
$lng['home_total_coins'] = 'These are amounts of dCoins (dUSD, dEUR, etc.), created by all users over time.';
$lng['home_total_coins_personal'] = 'These are amounts of [currency], created by all users over time.';
$lng['home_coins_pct_y'] = 'This is a %, with which [currency] is created on the balance of any account, except for miner\'s.';
$lng['home_miners_text'] = 'Users, participating in creation (emission) of dCoins.';
$lng['unless_reduction'] = 'If no coin volume decrease happens';
$lng['home_after'] = 'In';
$lng['i_will'] = 'I\'ll';
...
$lng['forecast_number_coins'] = 'Forecast of the coin volume';
$lng['after'] = 'After';
...
// credits
$lng['credits'] = 'Credits';
$lng['I_debtor'] = 'I\'m - debtor';
$lng['I_creditor'] = 'I\'m - creditor';
...
$lng['i_a_new_user'] = 'I\'m - a new user';
...
// arbitration
$lng['i_seller'] = 'I\'m - seller';
$lng['i_buyer'] = 'I\'m - buyer';
$lng['i_arbitrator'] = 'I\'m - arbitrator';
